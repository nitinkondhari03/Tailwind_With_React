  ...
  return (
    <div className="space-y-4 lg:flex">
      <div className='flex items-center justify-center lg:flex-1 lg:order-2'>
        ...
        <img src="../../public/assets/Pink-Shape.svg" alt="1st" className='absolute -rotate-[30deg] h-64 md;h-72 lg:h-[400px]'/>
        <img src="../../public/assets/Purple-Shape.svg" alt="1st" className='absolute -rotate-[15deg] h-64 md;h-72 lg:h-[400px]' />
        <img src="../../public/assets/Hero-Model.png" alt="1st" className='absolute h-64 md;h-72 lg:h-[400px]'/>
      </div>
